...
namespace Tree_Coll
{
    public class BsTreeC:ITree
    {
        ...
        public void Add(int val)
        {
            ...
            Node currentrent = root;
            while (true)
            {
                if (val < currentrent.val)
                {
                    if (currentrent.left == null)
                    {
                        currentrent.left = new Node(val);
                        return;
                    }
                    currentrent = currentrent.left;
                }
                else
                {
                    if (currentrent.right == null)
                    {
                        currentrent.right = new Node(val);
                        return;
                    }
                    currentrent = currentrent.right;
                }
            }
        }
        ...
        public bool Equal(BsTreeC tree)
        {
